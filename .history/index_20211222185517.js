...
import totalValue from "./modules/totalValue.js";
...
del.addEventListener("click", ()=>{
    if (!choseSign){
        ...
        showValues.removeNumber(firstNumber, secondNumber);
    } else{
        secondNumber = secondNumber.slice(0, -1);
        showValues.removeNumber(secondNumber, secondNumber);
        calculate();
    }
})
...
function total(){
    totalValue(newScreen, result, screen2);
